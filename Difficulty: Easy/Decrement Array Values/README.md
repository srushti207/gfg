<h2><a href="https://www.geeksforgeeks.org/problems/decrement-array-values/1?page=1&category=Java&difficulty=Easy&status=unsolved&sortBy=submissions">Decrement Array Values</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an array <strong>arr[] </strong>that contains integers. You need to <strong>decrement</strong> each element of the array by&nbsp;<strong>1</strong> and <strong>return</strong> the array.</span></p>
