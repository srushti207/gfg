<h2><a href="https://www.geeksforgeeks.org/problems/input-string/1?page=1&category=Java&difficulty=Basic&status=unsolved&sortBy=submissions">Input String</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a text in the form of a string, you need to take <strong>input</strong> and <strong>print</strong> it.</span></p>
