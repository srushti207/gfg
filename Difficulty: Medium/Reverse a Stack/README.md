<h2><a href="https://www.geeksforgeeks.org/problems/reverse-a-stack/1?page=1&category=Stack,python&difficulty=Easy,Medium&status=unsolved&sortBy=submissions">Reverse a Stack</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given a stack <strong>St</strong>. You have to reverse the stack using recursion.</span></p>
